package com.intuit.playermicroservice.domain;
...
public class PagedResult<T> extends PageImpl<T> {
    ...
    @JsonCreator
    public PagedResult(@JsonProperty("content") final List<T> content,
    ...
    public PagedResult(final List<T> content, final long totalElements, final Pageable pageable) {
